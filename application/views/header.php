...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<div id="header-secondary"><h2 id="head"><img src="<?php echo base_url("images/toto.png"); ?>" id="logo-ka" height="60px">Reservasi Tiket Kereta Api Online</h2></div>

		<div id="header-primary"> 
			<ul id="navigation">
				<li><a href="<?php echo base_url("welcome"); ?>">Pesan Tiket</a></li>
				<?php
				...
				<?php } else { ?>
					<li><a href="<?php echo base_url("member/transaksi"); ?>">Histori Transaksi</a></li>
